...
namespace Math
{
    ...
    float simplex2(float x, float y, float frequencies, int octaves, float persistence, float lacunarity, float redistribution);

    // Get 3D simplex noise
    float simplex3(float x, float y, float frequencies, float z, int octaves, float persistence, float lacunarity, float redistribution);
